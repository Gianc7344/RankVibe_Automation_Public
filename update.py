"""
╔══════════════════════════════════════════════════════════════════════════════╗
║            RankVibe Automation — Tek Tıkla Güncelleme Aracı               ║
║                          (Git Gerektirmez)                                 ║
╠══════════════════════════════════════════════════════════════════════════════╣
║  Bu script GitHub'daki en güncel RankVibe kodlarını indirir ve             ║
║  yerel kurulumunuzu günceller.                                            ║
║                                                                            ║
║  KİŞİSEL VERİLERİNİZ KORUNUR:                                            ║
║    • .env (API anahtarlarınız)                                            ║
║    • downloads/ (indirilen videolar)                                      ║
║    • clips/ (klipler)                                                     ║
║    • final_videolar/ (çıktı videolar)                                     ║
...
GITHUB_REPO = "RankVibe_Automation_Public"
GITHUB_BRANCH = "main"
...
PROTECTED_EXTENSIONS = [".mp3", ".mp4", ".db", ".sqlite3", ".log", ".pyc", ".avi", ".mkv", ".wav"]

BACKUP_DIR_NAME = "_rankvibe_backup"
...
def print_banner():
    print()
    print("╔══════════════════════════════════════════════════════════════╗")
    print("║      🎬 RankVibe Automation Güncelleme Aracı v1.0          ║")
...
def download_with_progress(url: str, dest_path: str) -> bool:
    try:
        ...
        print()
        req = urllib.request.Request(url, headers={"User-Agent": "RankVibe-Updater/1.0"})
...
def run_update():
    ...
    try:
        test_req = urllib.request.Request(
            ...
            headers={"User-Agent": "RankVibe-Updater/1.0"}
        )
    ...
    print("      • downloads/ (indirilen videolar)")
    print("      • clips/ (klipler)")
    print("      • final_videolar/ (çıktı videolar)")
    print("      • thumbnails/ (küçük resimler)")
    print()
...
if __name__ == "__main__":
    try:
        success = run_update()
        if success:
            print("  🚀 RankVibe Automation'ı yeniden başlatarak güncel sürümü kullanabilirsiniz.")
        else:
